...
-- Generated at: 2026-06-18T20:59:48.867Z
...
CREATE TABLE "Blitz" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL, "confirmDeadline" DATETIME, "maxParticipants" INTEGER,
...
CREATE TABLE "BlitzParticipant" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL, "targetDeals" INTEGER,
...
CREATE TABLE "PayrollEntry" (
    ...
    "notes" TEXT NOT NULL DEFAULT '',
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL, "idempotencyKey" TEXT, "amountCents" INTEGER NOT NULL DEFAULT 0, "paidAt" DATETIME, "isChargeback" BOOLEAN NOT NULL DEFAULT 0, "chargebackOfId" TEXT, "originalAmountCents" INTEGER, "editedAfterPaidAt" DATETIME, "editedBy" TEXT, "editReason" TEXT, "chargeCategory" TEXT,
...
CREATE UNIQUE INDEX ProductPricingVersion_one_open_per_product ON ProductPricingVersion(productId) WHERE effectiveTo IS NULL;
CREATE INDEX "ProductPricingVersion_productId_effectiveFrom_idx" ON "ProductPricingVersion"("productId", "effectiveFrom");
CREATE UNIQUE INDEX ProductPricingVersion_productId_effectiveFrom_key ON ProductPricingVersion(productId, effectiveFrom);
