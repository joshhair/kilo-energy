...
export default function TermsPage() {
  return (
    <>
      <h1 className="text-3xl font-black text-[var(--text-primary)] mb-2" style={{ fontFamily: "'DM Serif Display', serif" }}>
        Terms of Service
      </h1>
      <p className="text-sm text-[var(--text-primary)]/50 mb-8">Last updated {LAST_UPDATED}</p>

      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">1. The service</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">2. Your account</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">3. Acceptable use</h2>
      ...
      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">4. Data ownership</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">5. Commission calculations</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">6. Service changes</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">7. Termination</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">8. Disclaimer</h2>
      <p>
      ...
      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">9. Governing law</h2>
      <p>
        These terms are governed by the laws of the State of California, without regard to conflict-of-law principles.
      </p>

      <h2 className="text-xl font-bold text-[var(--text-primary)] mt-8 mb-3">10. Contact</h2>
      <p>
