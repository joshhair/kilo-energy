...
export default function DashboardPage() {
  ...
  if (effectiveRole === 'project_manager') {
    return <PMDashboard projects={periodProjects} allProjects={projects} period={period} setPeriod={setPeriod} PERIODS={PERIODS} totalReps={reps.filter(r => r.active !== false).length} currentRepName={effectiveRepName} />;
  }
