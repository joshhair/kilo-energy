export default function DashboardLoading() {
  return (
    <div className="p-6 space-y-6">
      {/* Header placeholder */}
      <div className="h-8 w-48 rounded-lg bg-[var(--surface-card)] animate-skeleton" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {[0, 1, 2].map((i) => (
          ...
          >
            ...
            <div className="h-3 w-full rounded bg-[var(--surface-card)]/50 animate-skeleton" style={{ animationDelay: `${i * 120 + 120}ms` }} />
          </div>
        ))}
      </div>
    </div>
