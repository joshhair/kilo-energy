        ...
        <button
          ...
          className={`flex items-center gap-1 text-xs px-2 py-1 rounded-lg border transition-colors ${
            disabled
              ...
              : 'border-[var(--accent-green)]/50 text-[var(--accent-green)] hover:bg-[var(--accent-green)]/10'
          }`}
        >
            ...
            return (
              ...
              >
                <select
                  ...
                  className="bg-[var(--surface-card)] border border-[var(--border)] text-white rounded-lg px-2 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-[var(--accent-green)]"
                >
                ...
                <input
                  ...
                  placeholder="M1"
                  className="bg-[var(--surface-card)] border border-[var(--border)] text-white rounded-lg px-2 py-1 text-xs text-right tabular-nums focus:outline-none focus:ring-2 focus:ring-[var(--accent-green)]"
                />
                <input
                  type="number"
                  step="0.01"
