    ...
    <div className="px-3 pt-2 pb-4 md:p-8 animate-fade-in-up">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[var(--text-secondary)] text-sm font-medium mt-1 tracking-wide">{hasActiveFilters ? `${filtered.length} of ${statusFiltered.length} projects` : `${statusFiltered.length} total projects`}</p>
        </div>
