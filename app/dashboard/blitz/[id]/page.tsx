                  ...
                  {(() => {
                    ...
                    <tr key={p.id} className={`border-b border-[var(--border-subtle)]/50 last:border-0 hover:bg-[var(--surface-card)]/40 transition-colors ${idx % 2 === 0 ? 'bg-[var(--surface)]/20' : ''}`}>
                      ...
                      <td className="px-4 py-3">
                        <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${p.joinStatus === 'approved' ? 'bg-[var(--accent-emerald-soft)] text-[var(--accent-emerald-text)]' : p.joinStatus === 'pending' ? 'bg-[var(--accent-amber-soft)] text-[var(--accent-amber-text)]' : p.joinStatus === 'invited' ? 'bg-[var(--accent-blue-soft)] text-[var(--accent-blue-text)]' : p.joinStatus === 'waitlist' ? 'bg-[var(--accent-cyan-soft)] text-[var(--accent-cyan-text)]' : 'bg-[var(--accent-red-soft)] text-[var(--accent-red-text)]'}`}>
                          {p.joinStatus}
                        </span>
                      </td>
