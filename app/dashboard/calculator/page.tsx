              ...
              <div key={resultHash}>
                ...
                <div style={{
                  ...
                  <p style={{ fontSize: 44, fontWeight: 700, color: 'var(--accent-green)', fontFamily: "'DM Serif Display', serif", letterSpacing: '-0.03em', textShadow: '0 0 20px #00e07a50', lineHeight: 1 }}>
                    ${((reps.find(r => r.id === currentRepId)?.repType === 'setter' || (reps.find(r => r.id === currentRepId)?.repType === 'both' && selectedSetterId === currentRepId)) && !isSelfGen ? animatedSetterTotal : animatedCloserTotal).toLocaleString()}
                  </p>
                </div>
